...
<input type="hidden" name="kullaniciid" value="<?php echo $kullanicicek['kullanici_id'] ?>">
                                    <div class="row">
                                        <div class="col-md-12 col-12 mb-20">
                                            ...
                                            <input  name="yeniadet" required="" class="mb-0" type="text" placeholder="Yeni Adet Sayısını Giriniz.">
                                        </div>
                                        ...
                                        <div class="col-12 mb-20">
                                            ...
                                            <input minlength="18" name="not" required="" class="mb-0" type="text" placeholder="Notunuzu Giriniz.">
                                        </div>
                                        <div class="col-md-12">
