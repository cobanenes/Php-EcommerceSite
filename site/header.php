...
<head>
        ...
        <!-- Favicon -->
        <link rel="shortcut icon" type="image/x-icon" href="admin/resimler/logo/<?php echo $ayarcek['logo']?>">
    ...
    <div class='modal__container'>
        <img class="modal__img" src="<?php echo $ayarcek['pimg']?>">
        
        <div class="modal__content">
            <h1 class="modal__title"><?php echo $ayarcek['pb'] ?>
                <h1>
                    <p class="modal__paragraph"><?php echo $ayarcek['pa'] ?></p>
                ...
                <div class="header-middle pl-sm-0 pr-sm-0 pl-xs-0 pr-xs-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="logo pb-sm-30 pb-xs-30">
                                    <a href="index">
                                        <img src="admin/resimler/logo/<?php echo $ayarcek['logo']?>" width="100" height="100" alt="Header Logo">
                                    </a>
                                </div>
                            </div>
                  ...
                  while ($kategoricek=$kategori->fetch(PDO::FETCH_ASSOC)) { ?>
                                   ...
                                   <?php  } ?>
                                    ...
                                    <button style="background-color: #91AA9D;  name=" kelimearama" class="li-btn" type="submit"><i class="fa fa-search"></i></button>
                                </form>                                <!-- Header Middle Searchbox Area End Here -->
                                <!-- Begin Header Middle Right Area -->
...
$sepettoplam+=$value * $urunlercek['urun_fiyat'] ;
                ...
                <div style="background-color: #91AA9D;"class="header-bottom header-sticky d-none d-lg-block d-xl-block">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="hb-menu">
                                    <nav>
                                        <ul>
                                            ...
                                            <li class="megamenu-holder"><a href="index">Kategorİler</a>
                  ...
                  while ($kategoricek=$kategori->fetch(PDO::FETCH_ASSOC)) { ?>
                                            ...
                                            <li><a href="bilgi">Sıkça Sorun Sorular</a></li>
