                    ...
                    while ($slidercek=$slider->fetch(PDO::FETCH_ASSOC)) { ?>
                                    ...
                                    <div style="background-image: url(Admin/resimler/slider/<?php echo $slidercek['slider_resim'] ?>) !important;" class="single-slide align-center-left  animation-style-01 bg-3">
                                        ...
                                        <div  class="slider-content">
                                            <h5 style="color:white"><?php echo $slidercek['slider_aciklama'] ?></h5>
                                            <h2 style="color:white"><?php echo $slidercek['slider_baslik'] ?></h2>
                                            <div  class="default-btn slide-btn">
                                                <a style="background-color: #91AA9D;" class="links" href="<?php echo $slidercek['slider_link'] ?>"><?php echo $slidercek['slider_button'] ?></a>
                                            </div>
                                        </div>
                                    </div>
<?php } ?>
            ...
            <div align="center"><img src="saaatlikf.png" alt="" /></div>
