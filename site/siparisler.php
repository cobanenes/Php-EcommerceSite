...
<td> <?php echo $sipariscek['siparis_id']?>
</td>
                                ...
                                <td class="quantity"><span class="amount"><?php echo $sipariscek['urun_adet'] ?></span></td>
                                <!---
                                <td class="quantity">
                                    <label>Adet</label>
                                    <div class="cart-plus-minus">
                                        <input value="" class="cart-plus-minus-box" value="1" type="text">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Eğer siparişiniz kargoya verildi ise siparişinizi güncelleyemezsiniz.      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">İptal</button>

        <a href="siparisguncelle"><button type="button" class="btn btn-primary">Siparişimi Güncelle</button></a>
      </div>
    </div>
  </div>
</div></td>
